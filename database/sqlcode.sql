...
CREATE TABLE IF NOT EXISTS public.parts(
	parts_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
	parts_windshield_wipers character varying NOT NULL,
	parts_engine character varying NOT NULL,
	parts_spark_plugs character varying NOT NULL,
